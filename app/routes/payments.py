...
<div dir="rtl" style="font-family:Arial,Helvetica,sans-serif;max-width:560px;margin:0 auto;background:#ffffff;border:1px solid #E5E7EB;border-radius:12px;overflow:hidden;">
  ...
  <div style="padding:28px 32px;">
    ...
    <div style="background:#F5F3FF;border:2px solid #8B5CF6;border-radius:10px;padding:20px;text-align:center;margin:0 0 28px;">
      ...
      <a href="#" onclick="var k=document.getElementById('betaKey').textContent.trim();navigator.clipboard.writeText(k);this.textContent='✅ הועתק!';setTimeout(()=>this.textContent='📋 העתקת מפתח',2000);return false;" style="display:inline-block;padding:8px 20px;background:#8B5CF6;color:#fff;border-radius:6px;font-size:13px;font-weight:600;text-decoration:none;cursor:pointer;">📋 העתקת מפתח</a>
    </div>

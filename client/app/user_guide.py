...
פרטיות
Nudge מעבד תוכן מועתק כדי לספק פעולות AI. השתמשו בזהירות עם מידע רגיש.
...
Privacy
Nudge processes copied content to provide AI actions. Use care with sensitive information.
...
الخصوصية
يقوم Nudge بمعالجة المحتوى المنسوخ لتقديم ميزات الذكاء الاصطناعي. استخدمه بحذر مع البيانات الحساسة.
...
Конфиденциальность
Nudge обрабатывает скопированный контент для AI-действий. Будьте осторожны с чувствительными данными.
